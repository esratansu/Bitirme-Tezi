...
public class GoogleMapsApi extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String valueLocation = extra.getString("send_loca");
        String[] adres = valueLocation.split("[,:;?/]");

        if (valueLocation != "") {

            etLocation.setText(adres[0]);
        }
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (location != null && !location.equals("")) {
                    ...
                    Geocoder geocoder = new Geocoder(GoogleMapsApi.this);
                    try {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_lOCATION) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(getApplicationContext(), "User did not give location permission!!", Toast.LENGTH_SHORT).show();
            }
        }
